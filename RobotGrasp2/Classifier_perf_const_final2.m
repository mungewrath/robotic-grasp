...
[ave,upper,lower,kstat,kstatsterr] = rotandextrapold(perfx,perfy,loopn);
...
% [energyave,energyupper,energylower,energykstat,energykstatsterr] = rotandextrapold(rocenergx,rocenergy);
