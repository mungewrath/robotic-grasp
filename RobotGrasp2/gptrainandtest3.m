function [aucave,aucerr,aucstd,ave,uppererr,lowererr,upperstd,lowerstd,kstat,kstatsterr,kstatstd,mfout,indexout,abovecrit] = gptrainandtest2(x,y,index,groundtruth,loopn,leave,cutoff,fprtest)
...
%USE FOR STRIPPING OUT GRASPS LIKELY TO FALL IN TPR RANGES
...
%     [~,~,~,~,sumtemp] = truefalse([mf res],.8,.8);
    ...
    [mfnewtemp,~] = cutoffsearch(fprtest,perfx,perft,mf);
    abovecrit = [abovecrit;mfnewtemp];
