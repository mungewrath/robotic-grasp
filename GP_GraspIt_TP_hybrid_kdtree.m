...
%  This version uses a kdtree rather than static bins to divide up the
%  feature space.
%  Update 5/22/14: Changed to use corrected data and fixed normalizeer bug.
%%
